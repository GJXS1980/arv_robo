...
int main(int argc, char* argv[])
{
	...
	ros::init(argc, argv, "arv_awake_node");    //初始化节点，向节点管理器注册
	ros::NodeHandle n;
	ros::Publisher pub = n.advertise<std_msgs::Int32>("arv_awake_topic", 1);
	...
	*/
	...
	string path2 = ros::package::getPath("arv_voice_system");
	//printf(path.data());
	...
	nh.param("lgi_param", my_lgi_param, std::string("appid = 604adfa0,work_dir = ."));    //从launch文件获取参数
